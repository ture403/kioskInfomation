# 신한은행 프리미어(청담) Kiosk Project (shinhan-pwm)

신한은행 프리미어 패밀리오피스 청담센터에 설치되는 키오스크 프로젝트입니다. 방문 고객을 위한 실시간 안내, 층별 시설 안내, 최신 금융 경제 뉴스 제공 등을 목적으로 합니다.
...
- **[2026-05-12]**
  ...
  - 프론트엔드(설정): `index.html` 내 기본 Title을 "신한은행 프리미어"로 변경 및 투명 배경의 신한은행 공식 로고 파비콘(`favicon.ico`) 적용.
